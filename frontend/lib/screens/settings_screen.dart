...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _printTestPage() async {
    ...
    final testBoxesData = List.generate(15, (index) {
      ...
      return {
        'boxCode': 'BOX$boxNum',
        'lqcDate': '2026-01-09T${hour.toString().padLeft(2, '0')}:${minute.toString().padLeft(2, '0')}:00.000Z',
      };
    });
    ...
    final success = await PrintService.printRejectionTicket(
      ...
      operatorId: 'EMP001',
      observations: 'Esta es una impresión de prueba para verificar la configuración de impresora, márgenes y tamaño de papel.',
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(success ? 'Página de prueba enviada' : 'Error al imprimir'),
              ...
              children: [
                ...
                const Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Configura la impresora y formato de impresión para rechazos',
                      style: TextStyle(
                                  ...
                                  Column(
                                    children: [
                                      DropdownButtonFormField<String>(
                                        initialValue: _printers.any((p) => p.name == _config.printerName) ? _config.printerName : null,
                                        ...
                                        items: [
                                          const DropdownMenuItem(
                                            value: null,
                                            child: Text('Mostrar diálogo de impresión'),
                                          ),
                                          ..._printers.map((printer) => DropdownMenuItem(
                                            ...
                                            child: Row(
                                              children: [
                                                Icon(
                                                  printer.isDefault ? Icons.star : Icons.print_outlined,
                                                  size: 16,
                                                  color: printer.isDefault ? AppTheme.warningColor : AppTheme.textMuted,
                                                ),
                                                const SizedBox(width: 8),
                                                Expanded(child: Text(printer.name, overflow: TextOverflow.ellipsis)),
